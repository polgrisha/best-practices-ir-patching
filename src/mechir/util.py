...
def batched_dot_product(a: Tensor, b: Tensor):
    ...
    """
    # return a @ b.T
    return torch.bmm(a.unsqueeze(-2), b.unsqueeze(-1)).squeeze(-1).squeeze(-1)

def cosine_similarity(a: Tensor, b: Tensor):
    """
    Calculating the cosine similarity between two tensors a and b.
    ...
    return batched_dot_product(a_norm, b_norm)
